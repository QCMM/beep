...
short_description = "A binding energy evaluation platform and database for molecules on interstellar ice-grain mantels".split("\n")[0]
...
setup(
    ...
    install_requires=['matplotlib', 'scipy<1.8', 'tqdm', 'seaborn' ],
