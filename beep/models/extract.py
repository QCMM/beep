...
class ExtractConfig(BaseModel):
    ...
    stoichiometry: str = Field("bsse", description="Stoichiometry type for BE extraction: bsse (BSSE-corrected), be_nocp, ie (counterpoise interaction), ie_nocp (ghost-free interaction, for MLPs), or de")
    ...
    _lower_opt_method = field_validator("opt_method")(lowercase_str)
    _lower_basis = field_validator("basis")(lowercase_str)
    _lower_be_methods = field_validator("be_methods")(lowercase_list)
